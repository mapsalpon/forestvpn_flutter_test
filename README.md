...
## Примечания от меня
1. Во время написания брал моковые данные с оригинального репозитория, но пришлось поменять ссылки на картинки.
2. Писал под Material, поэтому дизайн в моментах расходится, если нужно, перепишу под Cupertino.
3. Снизу главного экрана добавил кнопку для обнуления прочитанных новостей.
4. Использовал Provider, т.к. мне с ним было немного комфортнее.
